...
{
    public static void SavePlayerData(PlayerHandler player, Keybinds keybinds)
    {
        ...
        PlayerDataToSave data = new PlayerDataToSave(player, keybinds);
        //Write it and convert to bytes for the writingto binary
        formatter.Serialize(stream, data);
        //and done
        stream.Close();
    }   
    public static PlayerDataToSave LoadData(PlayerHandler player, Keybinds keybinds)
    {
        //Location to Save
        string path = Application.persistentDataPath + "/" + PlayerDataToSave.saveSlot;
